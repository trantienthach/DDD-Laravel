      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            ...
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/featured-icon.png') }}" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="icon-button">
                        <a href="{{ route('booking.property-details') }}"><i class="fa fa-calendar"></i> Schedule a visit</a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/property-01.jpg') }}" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$2.264.000</h6>
            <h4><a href="{{ route('booking.property-details') }}">18 New Street Miami, OR 97219</a></h4>
            <ul>
            ...
            <div class="main-button">
              <a href="{{ route('booking.property-details') }}">Schedule a visit</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/property-02.jpg') }}" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
            <h4><a href="{{ route('booking.property-details') }}">54 Mid Street Florida, OR 27001</a></h4>
            <ul>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/property-03.jpg') }}" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
            <h4><a href="{{ route('booking.property-details') }}">26 Old Street Miami, OR 38540</a></h4>
            <ul>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/property-04.jpg') }}" alt=""></a>
            <span class="category">Apartment</span>
            <h6>$584.500</h6>
            <h4><a href="{{ route('booking.property-details') }}">12 New Street Miami, OR 12650</a></h4>
            <ul>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/property-05.jpg') }}" alt=""></a>
            <span class="category">Penthouse</span>
            <h6>$925.600</h6>
            <h4><a href="{{ route('booking.property-details') }}">34 Beach Street Miami, OR 42680</a></h4>
            <ul>
              <li>Bedrooms: <span>4</span></li>
              <li>Bathrooms: <span>4</span></li>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="{{ route('booking.property-details') }}"><img src="{{ asset('assets/images/property-06.jpg') }}" alt=""></a>
            <span class="category">Modern Condo</span>
            <h6>$450.000</h6>
            <h4><a href="{{ route('booking.property-details') }}{{ route('booking.property-details') }}">22 New Street Portland, OR 16540</a></h4>
            <ul>
