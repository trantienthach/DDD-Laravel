...
<link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.2.0/css/fontawesome.css'><link rel="stylesheet" href="{{ asset('assets/css/login_style.css') }}">
...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form action="{{ route('manager.login') }}" method="POST" class="login">
                @csrf
